...
-   [ ] Confirm the textarea placeholder reads: `Add DOI(s), PubMed/PMID or PMCID records, arXiv IDs, BibTeX entries, and citations in supported styles for books, articles, chapters, and webpages. Separate multiple formatted citations with a blank line.`
