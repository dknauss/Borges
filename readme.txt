...
* **Tiny front-end payload** — only a small view script (~2.4 KB, plus WordPress's shared translation script) and stylesheet (~2.9 KB) load, and only on pages that actually contain a bibliography.
