...
| --------------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **ISBN-10 / ISBN-13** | Done (unreleased)            | Open Library Books API first (no key, open data), Google Books fallback (approved 2026-09-24 after Open Library's /api/books returned 404 from CI). Checksums verified in JS and PHP; ISBN-10 normalized to ISBN-13; bare ISBN-10 not accepted.                                                  |
